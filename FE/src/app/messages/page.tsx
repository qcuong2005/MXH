  ...
  //   Smile,
  //   Phone,
  //   Video, // (Bạn đã có icon này)
  //   Users,
  //   MoreVertical,
  //   Reply as ReplyIcon,
  //   X,
  //   Image as ImageIcon, // ✅ Đổi tên import để tránh trùng lặp
  // } from "lucide-react";
  ...
  // // ✅ 1. SỬA COMPONENT DẤU CHẤM NHẤP NHÁY
  // // (Sử dụng class 'typing-dot' tùy chỉnh thay vì 'animate-pulse')
  // const TypingIndicator = () => (
  //   <div className="flex items-center space-x-1">
  //     <span
  //       className="w-2 h-2 bg-gray-400 rounded-full typing-dot"
  //       style={{ animationDelay: "-0.3s" }} // CSS nội tuyến cho delay
  //     ></span>
  //     <span
  //       className="w-2 h-2 bg-gray-400 rounded-full typing-dot"
  ...
  //     // Logic nhận "newMessage" (Không đổi)
  ...
  //     // Logic "userOnline", "userOffline" (Không đổi)
  ...
  //     // Logic "userTyping" (Không đổi, đã đúng)
  //     s.on("userTyping", (userId: number) => {
  //       // (Bạn có thể thêm console.log ở đây để debug nếu muốn)
  //       // console.log(`[Socket] Nhận được 'userTyping' từ ID: ${userId}`);
  ...
  //   // Logic tải lịch sử tin nhắn (Không đổi)
  //   useEffect(() => {
  ...
  //   // Logic handleSendMessage (Không đổi)
  ...
  // Lấy thông tin người nhận để gửi sang trang /call
  const receiverId = selectedChat.id.toString();
  const receiverName = selectedChat.name || selectedChat.username || "Người dùng";
  const receiverAvatar = selectedChat.avatar || anhmacdinh.src;
