...
export default function ChatWindow({
  ...
  // ✅ LOGIC GỌI ĐIỆN (chỉ hỗ trợ 1-1, group tạm khóa)
  const handleStartCall = async (callType: "voice" | "video") => {
    if (!selectedChat || !currentUser || !socket || selectedChat.isGroup) {
      // Nếu là group → tạm khóa
      alert("Chức năng gọi nhóm đang phát triển");
      return;
    }
    ...
    <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900 h-full min-h-0">
      ...
      <div className="p-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between flex-shrink-0 bg-white dark:bg-gray-800 shadow-sm">
        ...
        <div className="flex items-center space-x-1.5">
          ...
          {/* Chỉ hiện nút MoreVertical (info) khi là group */}
          {isGroup && (
            <button
      ...
      {/* Modal Group Info - chỉ mở khi là group và click nút More */}
