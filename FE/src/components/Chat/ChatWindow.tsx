...
import { sendGroupMessageApi } from "@/services/group";
  ...
  console.log("incomingCall",incomingCall)
   ...
   const handleSendMessage = async (e: React.FormEvent) => {
    ...
    // 1. Tạo tin nhắn Optimistic (Hiển thị ngay lập tức để UX mượt)
    const optimisticMessage = {
      ...
      read: false,
      reply_to: replyMessage ? replyMessage : null, // Object đầy đủ để hiển thị UI
      // Nếu là group, thêm thông tin group
    ...
    try {
      if (selectedChat.isGroup) {
        ...
        // Lưu ý: Sau khi gọi API thành công, Server nên emit socket event 
        // để tất cả thành viên (kể cả người gửi) nhận được tin nhắn chính thức.
      } else {
        // --- LOGIC GỬI 1-1 (CŨ) ---
      ...
      // Xử lý lỗi: Xóa tin nhắn optimistic hoặc hiện thông báo lỗi
    }
  };
