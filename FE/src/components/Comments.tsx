...
//       setComments((prev) =>
//         prev.map((c) => {
//           if (c.id === replyingTo) return { ...c, children: [...(c.children || []), newReply] };
...
//         const visibleChildren = isCollapsed ? c.children.slice(0, 2) : c.children;
...
//                 <div className="font-medium text-gray-800">{c.user.username}</div>
...
//                   className="ml-2 bg-blue-500 text-white px-3 py-1 text-sm rounded-full hover:bg-blue-600 flex items-center"
//                 >
//                   <Send size={14} />
//                 </button>
//               </div>
...
//       {showComments && (
//         <div className="mt-3 border-t pt-3">{renderComments(comments)}</div>
//       )}
//     </div>
//   );
// }
