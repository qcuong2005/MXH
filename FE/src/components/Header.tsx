...
// import { Bell, User, Moon, Sun, Shield, Menu } from "lucide-react";
...
export default function Header() {
  ...
  // --- 2. STATE QUẢN LÝ MODAL BÀI VIẾT (QUAN TRỌNG) ---
  ...
  // 1. Đồng bộ user + theme + role từ localStorage
  useEffect(() => {
    const syncUser = () => {
      const token = localStorage.getItem("token");
      const userId = localStorage.getItem("userId");
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={notifRef}>
              ...
              {showNotifications && (
                <div className="absolute top-14 right-0 z-50 w-96 shadow-2xl bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                  {/* 3. TRUYỀN HÀM XỬ LÝ CHO NOTIFICATIONS */}
                  <Notifications 
        ...
        <div className="flex items-center justify-between pt-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={mobileNotifRef}>
              ...
              {showNotifications && (
                <div className="absolute top-16 right-0 z-50 w-[90vw] max-w-sm shadow-2xl bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                  {/* 3. TRUYỀN HÀM XỬ LÝ CHO NOTIFICATIONS (MOBILE) */}
                  <Notifications 
                    currentUser={currentUser} 
                    onCloseDropdown={() => setShowNotifications(false)}
                    onOpenPost={(id) => setViewPostId(id)}
